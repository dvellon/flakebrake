const nodes = Object.fromEntries(
  [
    ...
    "actual-facts", "proof-stages", "readback-note", "toast", "scenario-select",
    "hero-eyebrow", "hero-lead", "hero-result", "hero-copy", "scenario-transition",
    "basis-context", "proposal-heading", "activity-title", "runtime-heading",
...
const originalHeroPresentation = {
  resolvedBasis: "Resolved through bounded replan: the original over-capacity basis remains visible for audit, while the accepted alternative is verified.",
...
async function mutate(path, body) {
  ...
  const intent = path === "/api/mission"
    ...
    : path === "/api/scenario" ? "scenario_switch" : "approval";
